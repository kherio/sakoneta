...
function t(string $clave): string {
    static $textos = [
        'es' => [
            ...
            'ver_todas_competiciones' => 'Todas las competiciones →',
            ...
            'ver_competicion' => 'Ver competición →',
            'proximamente' => 'Próximamente',
            'ultimas_competiciones' => 'Últimas competiciones',
        ...
        'eu' => [
            ...
            'ver_todas_competiciones' => 'Txapelketa guztiak →',
            ...
            'ver_competicion' => 'Txapelketa ikusi →',
            'proximamente' => 'Laster',
            'ultimas_competiciones' => 'Azken txapelketak',
